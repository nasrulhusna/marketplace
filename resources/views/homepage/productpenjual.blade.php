...
@endsection
  ...
  <div id="heading-breadcrumbs">
      ...
      <div class="container text-center">
          ...
          <tr>
            <th>Alamat</th><td>{{$user->address}}</td>
          </tr>
          <tr>
            <th>Foto</th><td><img src="{{url($user->photo)}}" width="80px"></td>
          </tr>
          <tr>
            <th>Telepon</th><td>{{$user->phone}}</td>
          </tr>
        </table>
            </div>
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="box-simple">
                  <div class="icon-outlined"><img src="{{ url($product->photo) }}" width="200%" class="img img-thumbnail img-circle"></div>
                 <h3 class="h4"> <a href="{{url('product/detail/'.$product->slug) }}">{{ $product->name }}</a></h3>
