                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/user/update') }}">
                        ...
                        <!-- addres -->
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" required autocomplete name="address">{{ $user->address }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="birthday" class="form-control" value="{{ $user->birthday}}" required autocomplete>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="role" class="form-control">
                                    ...
                                    <option value="supplier" selected="selected">Suplier</option>
                                    <option value="member">Member</option>
                                    @else
                                    <option value="admin">Admin</option>
                                    <option value="supplier">Suplier</option>
